...
class DeleteWashHandsReminderLocationUseCase @Inject constructor(
    ...
    suspend operator fun invoke(washHandsReminderLocation: WashHandsReminderLocationDomainModel) =
        washHandsReminderLocationsRepository.deleteWashHandsReminderLocation(washHandsReminderLocation)
