...
class InsertWashHandsReminderLocationUseCase @Inject constructor(
    ...
    suspend operator fun invoke(washHandsReminderLocation: WashHandsReminderLocationDomainModel) =
        washHandsReminderLocationsRepository.insertWashHandsReminderLocation(washHandsReminderLocation)
